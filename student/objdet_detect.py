...
##
from tools.objdet_models.resnet.models.fpn_resnet import * 
from tools.objdet_models.resnet.models.resnet import *
from tools.objdet_models.resnet.utils.evaluation_utils import decode, post_processing
...
def load_configs_model(model_name='darknet', configs=None):
    ...
    if model_name == "darknet":
        ...
        configs.use_labels_as_objects=False#
        ##
        configs.heads = {
...
def load_configs(model_name='fpn_resnet', configs=None):
    ...
    configs.lim_r = [0, 1] # reflected lidar intensity
